...
from flux.sampling import denoise_midpoint,denoise_fireflow, denoise_fireflow_M, denoise_rf_solver, denoise, denoise_m,get_schedule, prepare, unpack
...
if __name__ == "__main__":
    ...
    parser.add_argument('--source_img_dir', default='examples/source/boy.jpg', type=str,
    ...
    parser.add_argument('--output_dir', default='examples/edit-result/cmp', type=str,
                        help='the path of the edited image')
    parser.add_argument('--output_prefix', default='fireflow_m', type=str,
                        help='prefix name of the edited image')
    parser.add_argument('--sampling_strategy', default='fireflow_m', type=str,
    ...
    parser.add_argument('--seed', type=int, default=1234,
                        help='random seed')
    parser.add_argument('--w', type=float, default=0.94,
                        help='w')
